...
function startServer(options) {
  ...
  server.listen(PORT, HOST, () => {
    console.log(`CORS Proxy berjalan di ${HOST}:${PORT}`);
    console.log('Gunakan format: /https://example.com atau /http://example.com');
  });
}

// Jalankan server dengan konfigurasi default
startServer({
  originBlacklist: [],
  originWhitelist: [],
  requireHeader: null,
